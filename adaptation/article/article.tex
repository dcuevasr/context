...
Together with the results by \cite{Heald_Contextual_2021}, our results show that many behavioral phenomena observed across different experiments can be explained by the uncertainty in context inference and its effects on learning and action selection.
