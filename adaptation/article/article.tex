...
\label{fig:model}
\end{figure}
\todo{Probably remove the top plots, as they are hard to explain and add very little to the paper}
While these priors are not mathematically equivalent to those used by \cite{Heald_Contextual_2021}, the prior samples they produce can be shown to be similar. For more details, see the supplementary materials. \todo{Do this}
